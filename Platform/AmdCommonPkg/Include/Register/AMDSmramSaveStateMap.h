...
#ifndef __AMD_SMRAM_SAVE_STATE_MAP_H__
#define __AMD_SMRAM_SAVE_STATE_MAP_H__

// Default SMBASE address
#define AMD_SMM_DEFAULT_SMBASE           0x30000

// Offset of SMM handler from SMBASE
#define AMD_SMM_HANDLER_OFFSET           0x8000
...
// AMD64-bit SMRAM Save State Map
typedef struct {
  // Padded an extra 0x200 bytes to match Intel/EDK2
  UINT8   Reserved[0x200];  // fc00h
  // AMD Save State area starts @ 0xfe00
